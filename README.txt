...
2) Заполнить необходимые параметры расчета в конфигурационном файле parameters.yml в папке /conf_files.
	...
	--- exception_file содержит путь к файлу с исключаемыми скважинами(в случае перевода скважины
			   на другой объект или аварии), расширение файла .xlsx. Необходимо, чтобы в
	...
	--- project_fond_file содержит путь к файлу с проектными скважинами. Расширение файла .xlsx.
		В файле должна находиться таблица формата выгрузки ArcGIS со столбцами в указанном порядке:
			NSKV - название скважины
			X - координата по оси X
			Y - координата по оси Y
			PLAST - объекты проектной скважины
		Варианты значений: "files/Название_Файла.xlsx" - происходит загрузка файла и учет проектных скважин
				   "нет" - проектных скважин нет
